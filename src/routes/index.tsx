...
function Logo({ size = "md" }: { size?: "sm" | "md" }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div
        className={`${box} grid place-items-center rounded-xl bg-secondary border border-border`}
      >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 pt-20 pb-28 lg:grid-cols-2">
        <div className="animate-reveal">
          ...
          <p className="mb-10 max-w-[52ch] text-pretty text-lg text-muted-foreground">
            Análise automática de conflitos medicamentosos e contraindicações para maior segurança
            do paciente. MedSystem cruza histórico, alergias e tratamentos em segundos — antes da
            prescrição sair.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 flex flex-col items-end justify-between gap-8 md:flex-row">
          <div className="max-w-xl">
            ...
            <p className="mt-5 text-muted-foreground">
              Estima-se que 7% das prescrições hospitalares contenham erros. MedSystem elimina o
              ponto cego do médico ao processar décadas de histórico em milissegundos.
            </p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {items.map((it) => (
            <div
              key={it.title}
              className="rounded-2xl border border-border bg-card p-7 transition-all hover:border-primary/40"
            >
  ...
  const steps = [
    {
      ...
      desc: "Conectamos com seu sistema de prontuário ou ERP atual sem fricção.",
    },
    {
      n: "02",
      title: "Análise em Tempo Real",
      desc: "MedSystem cruza histórico, alergias e tratamentos em curso instantaneamente.",
    },
    {
      n: "03",
      title: "Alerta Visual Inteligente",
      desc: "Indicadores cromáticos mostram o nível de risco — verde, amarelo ou vermelho.",
    },
    {
      n: "04",
      title: "Aprovação Segura",
      desc: "Confirme a prescrição com laudo técnico gerado como respaldo clínico.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {items.map((it) => (
            <div
              key={it.title}
              className="rounded-2xl border border-border bg-card p-8 transition-all hover:border-primary/40"
            >
              <div className="mb-5 grid size-11 place-items-center rounded-xl bg-secondary border border-border">
                <it.icon className="size-5 text-primary" />
              </div>
    ...
    <section className="relative overflow-hidden border-t border-border py-28">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mb-10 text-lg text-muted-foreground">
          Comece agora — gratuitamente — e veja em minutos como o MedSystem eleva o padrão de
          segurança da sua clínica.
        </p>
        <button
          type="button"
